...
const Twoway = () => {
    return ( 
      ...
      <div className="mt-50">
      <h1 className="text-4xl mb-10 font-semibold text-gray-600 text-center">2-WAY SMS</h1>
...
<p className="text-lg text-left font-semibold ml-2 pb-6">Sender ID set up cost for all Mobile Service Providers</p>
</div>
<table className="rounded-t-lg m-5 w-5/6 mx-auto bg-gray-200 text-gray-800">
  <tbody>
  <tr className="text-left border-b-2 border-gray-300">
