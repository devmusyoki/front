...
const CMS = () => {
    ...
    <div className="container ml-auto mx-auto px-40 lg:flex items-center lg:space-x-12">
  <div className="grid lg:grid-cols-3 mt-12 lg:mt-0 lg:gap-8">
    <div className="cursor-pointer group flex flex-col min-w-0 break-words bg-white mb-8 shadow-lg rounded-lg hover:bg-gray-500">
      ...
      <div className="relative text-white p-3 text-center inline-flex items-center justify-center w-12 h-12 mb-5 shadow-lg rounded-full bg-blue-400">
        ...
        <h6 className="text-xl font-semibold group-hover:text-white">LOREM IPSUM</h6>
            ...
            <div className="items-start flex flex-wrap ">
              ...
              <div className="w-full md:w-5/12 ml-auto mr-auto mt-9 px-8">
                <div className="md:pr-12 ml-20">
                  <h3 className="text-3xl font-semibold">Transforming Customer Engagement through Voice</h3>
...
<div className="mb-8">
      <h1 className="text-4xl ml-2 mt-0 mb-20 font-semibold text-gray-600 text-left">Phone Numbers</h1>
...
<table className="rounded-t-lg m-5 w-5/6 mx-auto bg-gray-200 text-gray-800">
  ...
  <tr className="bg-gray-100 border-b border-gray-200">
   ...
   <td className="px-4 py-3">Regular(Safaricom and Airtel) </td>
    <td className="px-4 py-3">KES 0</td>
  ...
  <td className="px-4 py-3">Toll Free (800 series) (Safaricom only)</td>
    <td className="px-4 py-3">KES 0</td>
    <td className="px-4 py-3">KES 20,000 + 16% VAT</td>
    <td className="px-4 py-3">KES 15,000 + 16% VAT</td>
    <td className="px-4 py-3"></td>
  </tr> 
  <tr className="bg-gray-100 border-b border-gray-200">
    
   <td className="px-4 py-3">Premium Rated(Safaricom only) </td>
    <td className="px-4 py-3">KES 0</td>
    <td className="px-4 py-3">KES 20,000 + 16% VAT</td>
    <td className="px-4 py-3">KES 15,000 + 16% VAT</td>
    <td className="px-4 py-3"></td>
...
<div className="mb-8">
      <h1 className="text-4xl ml-2 mt-0 mb-20 font-semibold text-gray-600 text-left">Local Charges</h1>
<p className="text-lg text-center font-bold m-5"></p>
<table className="rounded-t-lg m-5 w-5/6 mx-auto bg-gray-200 text-gray-800">
  <tbody>
  <tr className="text-left border-b-2 border-gray-300">
    ...
    <th className="px-4 py-3">Type </th>
    <th className="px-4 py-3">Cost Per Minute</th>  
  </tr>

    <tr className="bg-gray-100 border-b border-gray-200">
    <td className="px-4 py-3">Regular Outgoing </td>
    <td className="px-4 py-3">KES 0</td>
    <td className="px-4 py-3"></td>
  </tr> 

  <tr className="bg-gray-100 border-b border-gray-200">
    <td className="px-4 py-3">SIP Outgoing </td>
    <td className="px-4 py-3">KES 0</td>
    <td className="px-4 py-3"></td>
  </tr>

  <tr className="bg-gray-100 border-b border-gray-200">
    <td className="px-4 py-3">Regular Incoming </td>
    <td className="px-4 py-3">KES 0</td>
    <td className="px-4 py-3"></td>
  </tr>

  <tr className="bg-gray-100 border-b border-gray-200">
    <td className="px-4 py-3">SIP Incoming </td>
    <td className="px-4 py-3">KES 0</td>
    <td className="px-4 py-3"></td>
  </tr>

  <tr className="bg-gray-100 border-b border-gray-200">
    <td className="px-4 py-3">Toll Free Incoming </td>
    <td className="px-4 py-3">KES 0</td>
    <td className="px-4 py-3"></td>
  </tr>

  <tr className="bg-gray-100 border-b border-gray-200">
    <td className="px-4 py-3">SIP Trunk</td>
    <td className="px-4 py-3">KES 0</td>
    <td className="px-4 py-3"></td>
  </tr>
  </tbody>
  ...
  <div className="mb-8">
      <h1 className="text-4xl ml-2 mt-0 mb-20 font-semibold text-gray-600 text-left">International Charges</h1>
<p className="text-lg text-center font-bold m-5"></p>
